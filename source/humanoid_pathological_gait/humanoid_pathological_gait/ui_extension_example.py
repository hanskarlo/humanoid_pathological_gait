...
def some_public_function(x: int):
    print("[humanoid_pathological_gait] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[humanoid_pathological_gait] startup")
    ...
    def on_shutdown(self):
        print("[humanoid_pathological_gait] shutdown")
